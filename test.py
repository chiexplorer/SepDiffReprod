...
if __name__ == "__main__":
    ...
    parser = get_parser()  # 解析命令行参数
    parser = Trainer.add_argparse_args(parser)  # 初始化Trainer
    ...
    try:
        ...
        default_logger_cfg = default_logger_cfgs["testtube"]  # 默认使用testtube记录
        ...
        if hasattr(model, "monitor"):
            ...
            default_modelckpt_cfg["params"]["save_top_k"] = 3  # 3
